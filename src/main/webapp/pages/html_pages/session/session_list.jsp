...
<a href="../../../index.jsp">BetterMe</a>
  ...
  <div id="sessionbox">
    ...
    <h2 class="center">All experts</h2>
...
<br>
<br>
    <p>If you are in a life threatening situation - don’t use this site. Call +1 (800) 273-8255 or use these resources
      to get immediate help.</p>

  </footer>

  <div class="popup">
    <div class="pop">
      <h2>what is a session for?</h2>
      <a href="#" class="close" id="closeid">&times;</a>
    </div>
    <div class="pop_cont">
      <br>
      <p>It is an event , where you will be performing in front of 10 - 15 peoples , who also strugle with the same 
        fear of public speaking . so, that you can be confident about your speech. And also you would receive personal feedback,
        from the expert who is hosting the event and also a video of your speech will be sent to your personal expert and so he notices your 
        performance .
  ...
  <script src="<%=request.getContextPath() %>/pages/Js_pages/session/session_list.js">
